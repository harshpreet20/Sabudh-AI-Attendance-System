...
export default function AdminCurriculumPage() {
  ...
  async function handleDelete() {
    ...
    if (dbError) {
      ...
      if (deletingMaterial.storage_path) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage course materials and topics for all batches</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Upload your first course material or add a topic to get started."
          action={
